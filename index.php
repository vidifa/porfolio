...
<body id="inicio">
    ...
    <footer class="container">
        <div class="row mt-5 pb-3">
            ...
            <div class="col-12 col-sm-3 text-center text-sm-start">Sponsor <a href="https://depcsuite.com" target="_blank" title="DEPCSUITE">DePC
                    Suite</a>
            </div>
            <div class="col-12 col-sm-3 text-center text-sm-start pt-2 p-sm-0"><a href="mailto:info@grupojovima.com">info@grupojovima.com</a></div>
        </div>
    </footer>
